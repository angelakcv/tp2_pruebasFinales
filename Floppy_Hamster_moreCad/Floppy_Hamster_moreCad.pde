...
void iniciarJuego() {
  ...
  //esta cambia // para la bola demoledora
  ...
  //--------------------------------------------------------
  //Todo de polea
  //cadena extra para el inicio
  /*FCircle cir31 = new FCircle(30);
  cir31.setPosition(xi, yi+30);
  cir31.attachImage(Cadena);
  cir31.setRotatable(false);
  mundo.add(cir31);

  FCircle cir32 = new FCircle(30);
  cir32.setPosition(xi, yi+60);
  cir32.attachImage(Cadena);
  cir32.setRotatable(false);
  mundo.add(cir32);

  FCircle cir33 = new FCircle(30);
  cir33.setPosition(xi, yi+90);
  cir33.attachImage(Cadena);
  cir33.setRotatable(false);
  mundo.add(cir33);

  FCircle cir34 = new FCircle(30);
  cir34.setPosition(xi, yi+120);
  cir34.attachImage(Cadena);
  cir34.setRotatable(false);
  mundo.add(cir34);

  FCircle cir35 = new FCircle(30);
  cir35.setPosition(xi, yi+150);
  cir35.attachImage(Cadena);
  cir35.setRotatable(false);
  mundo.add(cir35);
  */
  ...
  //cadena extra
  /*FDistanceJoint cadenaPol36 = new FDistanceJoint(cir31, cir1);
  cadenaPol36.setLength(30);
  cadenaPol36.setFill(231, 209, 146);
  mundo.add(cadenaPol36);

  FDistanceJoint cadenaPol37 = new FDistanceJoint(cir32, cir31);
  cadenaPol37.setLength(30);
  cadenaPol37.setFill(231, 209, 146);
  mundo.add(cadenaPol37);

  FDistanceJoint cadenaPol38 = new FDistanceJoint(cir33, cir32);
  cadenaPol38.setLength(30);
  cadenaPol38.setFill(231, 209, 146);
  mundo.add(cadenaPol38);

  FDistanceJoint cadenaPol39 = new FDistanceJoint(cir34, cir33);
  cadenaPol39.setLength(30);
  cadenaPol39.setFill(231, 209, 146);
  mundo.add(cadenaPol39);

  FDistanceJoint cadenaPol40 = new FDistanceJoint(cir35, cir34);
  cadenaPol40.setLength(30);
  cadenaPol40.setFill(231, 209, 146);
  mundo.add(cadenaPol40);

  FDistanceJoint cadenaPol0 = new FDistanceJoint(bolaPolea, cir35);
  cadenaPol0.setLength(30);
  cadenaPol0.setFill(231, 209, 146);
  mundo.add(cadenaPol0);
  */
